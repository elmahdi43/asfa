package fr.asfa.assurance.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("fr.asfa.assurance.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("fr.asfa.assurance.security.DomainUserDetailsService", "createSpringSecurityUser");
