...
describe('Product e2e test', () => {
  ...
  const productSample = { contractNumber: 'vis-à-vie de grrr détacher', startDate: '2024-11-26', productType: 'VIRTUAL' };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      ...
      cy.get(`[data-cy="startDate"]`).type('2024-11-26');
      cy.get(`[data-cy="startDate"]`).blur();
      cy.get(`[data-cy="startDate"]`).should('have.value', '2024-11-26');

      cy.get(`[data-cy="endDate"]`).type('2024-11-26');
      cy.get(`[data-cy="endDate"]`).blur();
      cy.get(`[data-cy="endDate"]`).should('have.value', '2024-11-26');
