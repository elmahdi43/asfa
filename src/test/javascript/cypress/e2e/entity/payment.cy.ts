...
describe('Payment e2e test', () => {
  ...
  const paymentSample = { paymentDate: '2024-11-26', amount: 31157.14, timeStamp: '2024-11-26T01:17:28.865Z' };
  ...
  describe('new Payment page', () => {
    ...
    it('should create an instance of Payment', () => {
      cy.get(`[data-cy="paymentUID"]`).type('c49e5a00-a79b-460e-a8a6-5547a1bb5e53');
      cy.get(`[data-cy="paymentUID"]`).invoke('val').should('match', new RegExp('c49e5a00-a79b-460e-a8a6-5547a1bb5e53'));

      cy.get(`[data-cy="paymentDate"]`).type('2024-11-25');
      cy.get(`[data-cy="paymentDate"]`).blur();
      cy.get(`[data-cy="paymentDate"]`).should('have.value', '2024-11-25');

      cy.get(`[data-cy="amount"]`).type('14068.86');
      cy.get(`[data-cy="amount"]`).should('have.value', '14068.86');

      cy.get(`[data-cy="timeStamp"]`).type('2024-11-26T13:45');
      cy.get(`[data-cy="timeStamp"]`).blur();
      cy.get(`[data-cy="timeStamp"]`).should('have.value', '2024-11-26T13:45');
