...
describe('Category e2e test', () => {
  ...
  const categorySample = { label: 'cadre dès que' };
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      cy.get(`[data-cy="label"]`).type('discerner pour tellement');
      cy.get(`[data-cy="label"]`).should('have.value', 'discerner pour tellement');

      cy.get(`[data-cy="summary"]`).type('quoique');
      cy.get(`[data-cy="summary"]`).should('have.value', 'quoique');
